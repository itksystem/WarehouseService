...
const SQL = {
  ...
  BASKET : {  
    ...
    SQL_GET_ORDER_DETAILS : `SELECT * FROM warehouse_basket_item WHERE basket_id = $1 AND order_id = $2`,
    ORDER_DECLINE : `UPDATE pa_warehouse_service.warehouse_basket_item SET order_id = null WHERE basket_id = $2 AND order_id = $1`,
  }
};
