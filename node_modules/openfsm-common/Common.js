...
const SQL_COUNT_PRODUCT_IN_BASKET = `SELECT COUNT(item_id) FROM warehouse_basket_item WHERE basket_id=? and product_id=? and order_id is null`;
const SQL_GET_BASKET_ITEMS = `SELECT * FROM warehouse_basket_item WHERE basket_id = ?`;
